...
- any section where pages can be read independently — use [section navigation]({% link _patterns/section-navigation.md %}) instead

## Components

**[Next step]({% link _components/next-step.md %})** — forward and back buttons at the bottom of a page, linking to the previous and next page in the sequence. Use this component on every page in a chapter sequence.

**[Progress indicator]({% link _components/progress-indicator.md %})** — a step counter showing how far through the sequence the user is. Use this component inside [focus mode]({% link _patterns/focus-mode.md %}) multi-step form flows only. Do not add a progress indicator to informational chapter navigation — it is designed for form flows, not content sequences.
...
- [Next step]({% link _components/next-step.md %}) — forward and back navigation for chapter sequences.
- [Progress indicator]({% link _components/progress-indicator.md %}) — step progress for focus mode forms only.

## Related patterns

- [Focus mode]({% link _patterns/focus-mode.md %}) — the multi-step form flow pattern where a progress indicator is appropriate.
- [Section navigation]({% link _patterns/section-navigation.md %}) — use when pages can be accessed in any order.
