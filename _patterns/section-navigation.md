...
- [Sub-nav]({% link _components/sub-nav.md %}) — section navigation component for moving between pages within a section.

## Related patterns

- [In-page navigation]({% link _patterns/in-page-navigation.md %}) — for navigating within a single page, not between pages.
- [Chapter navigation]({% link _patterns/chapter-navigation.md %}) — for sequential multi-page flows where reading order carries meaning.
