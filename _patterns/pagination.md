...
- [Table]({% link _components/table.md %}) — filterable and sortable table; use pagination alongside when dataset exceeds 25 rows.
- [Manual list]({% link _components/manual-list.md %}) — manually curated content list.

## Related patterns

- [Search filters]({% link _patterns/search-filters.md %}) — combine with pagination on filtered result pages.
- [Empty state]({% link _patterns/empty-state.md %}) — what to show when filters reduce results to zero.
