...
- [Table of contents]({% link _components/table-of-contents.md %}) — in-page anchor navigation generated from H2 headings
- [Sub-nav]({% link _components/sub-nav.md %}) — section-level navigation between sibling pages
- [Filter sidebar]({% link _components/filter-sidebar.md %}) — filtering for search and catalogue pages; not a navigation component
