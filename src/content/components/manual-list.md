...
Use a manual list to present a curated group of links that an editor selects and orders by hand. Editors control what appears and in what order; the list does not update automatically. For lists that populate automatically, use the [Automated list](/components-advanced/automated-list/).
...
- [Feature link list](/components/feature-link-list/) – use when links benefit from descriptions and hover icons.
- [Automated list](/components-advanced/automated-list/) – use when the list should populate automatically from published content.
