...
layout: content
title: 'Tag'
description: 'A short label that signals status, audience, document type, or another classification axis.'
...
- a call to action – that belongs in a [callout](/components/callout/) or [next step](/components/next-step/)
...
- [Callout](/components/callout/) – for the page's most important sentence; not a substitute for a tag.
- [Banner](/components/banner/) – the page header that hosts tags.
