...
- [Banner](/components/banner/) – use for a page-level header rather than a standalone editorial feature.
- [Promo](/components/promo/) – use to highlight a single item rather than a full editorial feature.
