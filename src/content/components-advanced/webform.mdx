...
Use a Webform to collect structured information from users – feedback, enquiries, registrations, simple applications. Editors build the form in the CMS, where its fields, validation, and submission handling are configured, and the component renders it within the page.
